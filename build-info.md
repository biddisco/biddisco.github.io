...
-DHPX_WITH_PARCELPORT_VERBS_DEVICE:STRING=roq \
-DHPX_WITH_PARCELPORT_VERBS_IFNAME:STRING=ib0 \
-DHPX_WITH_PARCELPORT_VERBS_INTERFACE:STRING=roq0 \
-DHPX_WITH_PARCELPORT_VERBS_MAX_MEMORY_CHUNKS:STRING=100 \
-DHPX_WITH_PARCELPORT_VERBS_MEMORY_CHUNK_SIZE:STRING=4096 \
-DHPX_WITH_PARCELPORT_VERBS_MESSAGE_PAYLOAD:STRING=512 \
-DRDMAHELPER_WITH_LOGGING:BOOL=ON \
